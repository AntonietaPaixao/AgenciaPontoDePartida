...
<body>
				...
				<div class="collapse navbar-collapse" id="navbar-items">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navbar-li">
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="pacotes.jsp">Pacotes</a></li>
	...
	<main>
		<!--SESSÃƒO DE DESTAQUES-->
		<section>

			<div class="container" id="featured-container">
				<div class="col-12">
					<h2 class="title primary-color">Campeonados Vigentes</h2>
					<p class="subtitle secondary-color">PACOTES DE CAMPEONATOS</p>
				</div>
				<div class="col-12" id="featured-images">
					<div class="row g-4">
						<div class="col-12 col-md-4">
							<img src="img/Pacote1.png" alt="Projeto 1" class="img-fluid" />
							<div class="banner-content">
								<h3><a href="./views/Compra/createCompra.jsp">MaracanÃ£</a></h3>
							</div>
						</div>
						<div class="col-12 col-md-4">
							<img src="img/Pacote2.png" alt="Projeto 2" class="img-fluid" />
							<div class="banner-content">
								<h3><a href="./views/Compra/createCompra.jsp">Arena do Grêmio</a></h3>
							</div>
						</div>
						<div class="col-12 col-md-4">
							<img src="img/Pacote3.png" alt="Projeto 3" class="img-fluid" />
							<div class="banner-content">
								<h3><a href="./views/Compra/createCompra.jsp">Estádio Alfredo Schurog</a></h3>
							</div>
						</div>
						<div class="col-12 col-md-4">
							<img src="img/Pacote4.png" alt="Projeto 4" class="img-fluid" />
							<div class="banner-content">
								<h3><a href="./views/Compra/createCompra.jsp">Beira-Rio</a></h3>
							</div>
						</div>
						<div class="col-12 col-md-4">
							<img src="img/Pacote5.png" alt="Projeto 5" class="img-fluid" />
							<div class="banner-content">
								<h3><a href="./views/Compra/createCompra.jsp">Estádio Manoel Barradas</a></h3>
							</div>
						</div>
						<div class="col-12 col-md-4">
							<img src="img/Pacote6.png" alt="Projeto 6" class="img-fluid" />
							<div class="banner-content">
								<h3><a href="./views/Compra/createCompra.jsp">Morumbi</a></h3>
							</div>
						</div>
					</div>
				</div>
