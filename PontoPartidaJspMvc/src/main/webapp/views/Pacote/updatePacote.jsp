	...
	<main class="container" id="slider">
		...
		<section class="container py-3 bg-secondary-color my-5">
			...
			<form action="./edit-Pacote">
				<h2 class="text-center">Atualizar Pacote</h2>

				<div class="form-group mb-3">
					<label for="idPacote" class="form-label"> ID Pacote </label> <input
						type="number" id="idPacote" name="idPacote" class="form-control"
						value="<%=request.getAttribute("idPacote")%>" />
				</div>
				...
				<a href="updatePacote.jsp" class="btn btn-danger"
