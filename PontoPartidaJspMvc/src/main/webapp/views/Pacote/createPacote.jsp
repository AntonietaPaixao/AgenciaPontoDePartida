	...
	<main class="container" id="slider">
		...
		<section class="container py-3 bg-secondary-color my-5">
			...
			<form action="#">
				...
				<h4 class="text-center">Novo Pacote</h4>

				<div class="form-outline mb-3">
					<label for="partida">Partida</label> <select
						class="custom-select my-1 mr-sm-2" id="partida" name="partida">
						<option selected="">Selecione...</option>
						<option value="1">Flamengo x Cruzeiro</option>
						<option value="2">Gremio x Santos</option>
						<option value="3">Bahia x vitóriaSantos</option>
					</select>
				</div>

				<div class="form-group mb-3">
					<label for="nomePacote" class="form-label"> Nome do Pacote
					</label> <input type="text" id="nomePacote" name="nomePacote"
						class="form-control" />
				</div>
				...
				<div class="form-group mb-3">
					<label for="dataRetorno" class="form-label"> Data de
						Retorno </label> <input type="text" id="dataRetorno" name="dataRetorno"
						class="form-control" />
				</div>

				<div class="form-group mb-3">
					<label for="valorPacote" class="form-label"> Valor do
						Pacote </label> <input type="text" id="valorPacote" name="valorPacote"
						class="form-control" />
				</div>

				<button type="submit" class="btn btn-primary">Enviar</button>
				<a href="createPacote.jsp" class="btn btn-danger"
