	...
	<body>
		<header>
			<nav class="navbar navbar-expand-lg fixed-top bg-primary-color" id="navbar">
				<div class="container py-1">
					<a class="navbar-brand" href="#"> <img src="img/icone-PontoPartida.png" alt="Home" /> <span
					...
					<div class="collapse navbar-collapse " id="navbar-items">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navbar-li">
							...
							<li class="nav-item"><a class="nav-link" href="promocoes.jsp">Promo��es</a>
							</li>
		...
		<main>
			...
			<div class="container" id="info-container">
				<div class="col-12">
					<h2 class="title primary-color">Fale conosco</h2>
					<p class="subtitle secondary-color">Fale conosco</p>
				</div>
				<div class="col-12">
					<div class="row">
						<div class="col-12 col-md-5" id="info-banner">
							<img src="img/contato.png" alt="Informações" class="img-fluid" />
						</div>
						<div class="col-12 col-md-7 bg-secondary-color" id="info-content">
							<div class="row">
								<div class="col-12">
									<h2 class="title">Fale conosco:</h2>
									<p class="subtitle secondary-color">Estamos à disposição
										24 horas apra atendê-lo!</p>
								</div>
								<div class="col-12" id="info-numbers">
									<div class="row">
										<div class="col-4">
											<h3 class="primary-color">Fone</h3>
											<p class="primary-color">0800-9999999</p>
										</div>
										<div class="col-4">
											<h3 class="primary-color">Mail</h3>
											<p class="primary-color">contato@pontopartida.com.br</p>
										</div>
