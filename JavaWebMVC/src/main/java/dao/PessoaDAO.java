...
public class PessoaDAO {
	...
	public void save(Pessoa pessoa) {
		...
		String sql = "INSERT INTO PESSOA (cpf, nomePessoa, dataNascimento, sexo, email, telefone, idEndereco, idPermissao)" + " VALUES(?,?,?,?,?,?,?,?)";
	...
	//Inicio UPDATE
		public void update(Pessoa pessoa) {
			String sql = "UPDATE PESSOA SET cpf = ?, nomePessoa= ?, dataNascimento= ?, sexo= ?, email= ?, telefone= ?, idEndereco=?, IdPermissao= ?" + "WHERE idPessoa = ?";
